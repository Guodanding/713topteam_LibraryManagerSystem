...
void DBOperator::DBOpen()
{
    ...
    if(!openFlag)//如果未打开
    {
        ...
        dsn = QString("DRIVER={Microsoft Access Driver (*.mdb, *.accdb)};FIL={MS Access};DBQ=d:/libarysys/713topteam_LibraryManagerSystem/LibraryManager/database/LibraryData.accdb");
