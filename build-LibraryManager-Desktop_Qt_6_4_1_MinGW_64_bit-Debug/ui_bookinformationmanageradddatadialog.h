...
public:
    ...
    void setupUi(QDialog *BookInformationManagerAddDataDialog)
    {
        ...
        BookTypedepcbBox = new QComboBox(BookInformationManagerAddDataDialog);
        ...
        BookNUMlineEdit = new QLineEdit(BookInformationManagerAddDataDialog);
        BookNUMlineEdit->setObjectName("BookNUMlineEdit");
        BookNUMlineEdit->setGeometry(QRect(80, 110, 113, 21));
        label_9 = new QLabel(BookInformationManagerAddDataDialog);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(210, 220, 81, 21));
        label_9->setFont(font);
        PublishTimelineEdit = new QLineEdit(BookInformationManagerAddDataDialog);
    ...
    void retranslateUi(QDialog *BookInformationManagerAddDataDialog)
    {
        ...
        label_9->setText(QCoreApplication::translate("BookInformationManagerAddDataDialog", "\345\207\272\347\211\210\346\227\266\351\227\264", nullptr));
    } // retranslateUi
